  ...
  return (
    ...
    >
      ...
      >
        <Box
          sx={{
            maxWidth: 550, // Formaning kengligini kattaroq qilish
            width: "100%",
        ...
        >
          <Typography variant="h5" fontSize="36px" align="center" marginLeft='-190px' fontWeight="bold" gutterBottom>
            Тизимга кириш
          </Typography>
          ...
          <Button
            ...
            sx={{ marginTop: 3, fontSize: '16px',backgroundColor:"#5213e7"}}
            
            // Buton o‘lchamini kattaroq qilish
          >
            Тизимга кириш
          </Button>
          ...
          <Box display="flex" justifyContent="space-between" mt={3}>
            <Button
              ...
              style={{ fontSize: '12px', color:"#5213e7" }} // Kichikroq shrift
            >
              Рўйхатдан ўтиш
            </Button>
            <Button
